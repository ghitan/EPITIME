% ==============================================================================
%  COMPUTATIONAL COMPLEXITY ANALYSIS OF NSFD_behavioural
%  (part of EPITIME software)
%
%  This script evaluates the computational cost of the NSFD_behavioural 
%  solver by measuring:
%
...
close all; clear; clc;
fprintf('\nEPITIME behavioural: computational complexity analysis\n');
...
N_tried = 1000:5:10005;

behavioural_Problem.T = 100;
...
behavioural_Problem.h = behavioural_Problem.T/5;
behavioural_Problem.verbosity = 0;
[~,~,~] = NSFD_behavioural(behavioural_Problem);
...
Nsize = numel(N_tried);
Ndisp = ceil(Nsize / 10) * (1:10)';
k = 1;
fprintf('Performance benchmark started...\n0%%..');

for n = 1:Nsize 
    % Current number of time steps
    nt = N_tried(n);
    % Corresponding time step size
    behavioural_Problem.h = behavioural_Problem.T/nt;
    % CPU TIME MEASUREMENT
    func_handle = @() NSFD_behavioural(behavioural_Problem);
    ...
    [~,~,P] = NSFD_behavioural(behavioural_Problem);
    memoryAllocated(n) = P.memory_bytes;
    % Display running iterations percentage
    if ( n == Ndisp(k) ), fprintf('%d%%..', 10*k); k = k + 1; end
end
...
%  SAVE RESULTS
% =========================================================================
% save('behavioural_Benchmark_Results.mat')
%%
% =========================================================================
%  GRAPHICS SETTINGS
%
...
% MEMORY COMPLEXITY
subplot(1,2,1)
semilogy(N_tried, memoryAllocated,'LineWidth',2,'Color',[0.59,0.00,0.00]);
hold on
...
% TIME COMPLEXITY
subplot(1,2,2)
semilogy(N_tried, executionTime,'LineWidth',2,'Color','r');
hold on
...
% ==============================================================================
% End of behavioural_Performance_Benchmark.m
% ==============================================================================