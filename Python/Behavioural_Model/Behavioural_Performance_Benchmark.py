...
#
#  This script evaluates the computational cost of the NSFD_behavioural solver
#  by measuring:
#
...
# ==========================================================================
BeH_Problem["h"] = BeH_Problem["T"] / 5
_, _, _ = NSFD_behavioural(BeH_Problem)
...
for i, nt in enumerate(N_tried):
    ...
    # ----------------------------------------------------------------------
    BeH_Problem["h"] = BeH_Problem["T"] / nt
    ...
    # ----------------------------------------------------------------------
    stmt = lambda: NSFD_behavioural(BeH_Problem)
    ...
    # MEMORY MEASUREMENT
    # ----------------------------------------------------------------------
    _, _, P = NSFD_behavioural(BeH_Problem)
...
savemat(
    "behavioural_Python_Benchmark_Results.mat",
    {
        "N_tried": N_tried,
